...
namespace Engine
{
	...
	//현재 이거 사용중
	enum CHANNELID { SOUND_EFFECT, SOUND_BGM, SOUND_EFFECT_CONTINUE_CH1, SOUND_EFFECT_CONTINUE_CH2, SOUND_EFFECT_CONTINUE_CH3, SOUND_EFFECT_CONTINUE_CH4, SOUND_EFFECT_CONTINUE_CH5, MAXCHANNEL };
	...
	enum CHANNELID
	{
		...
		SOUND_BTN,
		SOUND_BGM,
		SOUND_EFFECT_CONTINUE_CH1,
		SOUND_EFFECT_CONTINUE_CH2,
		SOUND_EFFECT_CONTINUE_CH3,
