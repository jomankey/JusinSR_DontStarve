...
CSmoke::CSmoke(const CParticle& rhs)
	:CParticle(rhs)
	, m_fAccTime(0.f)
{
}
...
CSmoke* CSmoke::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring _strObjName, int numparticles, _vec3 _vPos, _float _fSize, _float _fLifeTime, _float _fSpeed)
{
