...
HRESULT CMainApp::SetUp_Setting(LPDIRECT3DDEVICE9* ppGraphicDev)
{
	...
	//owner Ui 
	FAILED_CHECK_RETURN(Engine::Ready_Font(m_pGraphicDev, L"Font_Count", L"굴림체", 7, 7, FW_THIN), E_FAIL);

	//UI
	FAILED_CHECK_RETURN(Engine::Ready_Font(m_pGraphicDev, L"Panel_Title", L"굴림체", 15, 15, FW_THIN), E_FAIL);
	FAILED_CHECK_RETURN(Engine::Ready_Font(m_pGraphicDev, L"Panel_Info", L"굴림체", 6, 10, FW_THIN), E_FAIL);
