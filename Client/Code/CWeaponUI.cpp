...
CWeaponUI::CWeaponUI(LPDIRECT3DDEVICE9 pGraphicDev, UI_STATE eUIState, const _tchar* _UI_Name, eITEMTOOL_TYPE _ItemToolType)
...
CWeaponUI* CWeaponUI::Create(LPDIRECT3DDEVICE9 pGraphicDev, UI_STATE _State, _vec3 _pos, _vec3 _size, const _tchar* _UI_Name,eITEMTOOL_TYPE _ItemToolType)
{
	CWeaponUI* pInstance = new CWeaponUI(pGraphicDev, _State, _UI_Name, _ItemToolType);
