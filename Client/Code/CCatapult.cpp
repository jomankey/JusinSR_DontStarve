...
HRESULT CCatapult::Add_Component()
{
	...
	m_pAnimCom->CreateAnimation(m_pGraphicDev, L"IDLE_LEFT", L"../Bin/Resource/Texture/Player/UnArmed/idle_up/idle_up__%03d.png", 22, 0.2f);
	m_pAnimCom->CreateAnimation(m_pGraphicDev, L"IDLE_DOWN", L"../Bin/Resource/Texture/Player/UnArmed/idle_down/idle_down__%03d.png", 22, 0.2f);
