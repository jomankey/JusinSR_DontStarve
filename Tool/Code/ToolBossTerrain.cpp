...
CToolBossTerrain::CToolBossTerrain(LPDIRECT3DDEVICE9 pGraphicDev)
	: CGameObject(pGraphicDev)
{
}

CToolBossTerrain::CToolBossTerrain(const CToolBossTerrain& rhs)
	: CGameObject(rhs.m_pGraphicDev)
{
}

CToolBossTerrain::~CToolBossTerrain()
{
}

HRESULT CToolBossTerrain::Ready_GameObject()
{
...
_int CToolBossTerrain::Update_GameObject(const _float& fTimeDelta)
{
	Input_Mouse();
...
void CToolBossTerrain::LateUpdate_GameObject()
{
	__super::LateUpdate_GameObject();
}

void CToolBossTerrain::Render_GameObject()
{
...
HRESULT CToolBossTerrain::Add_Component()
{
	...
	pComponent = m_pTextureCom = dynamic_cast<CTexture*>(proto::Clone_Proto(L"Proto_BossTexture"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
	m_mapComponent[ID_STATIC].insert({ L"Proto_BossTexture", pComponent });
...
void CToolBossTerrain::Input_Mouse()
{
...
HRESULT CToolBossTerrain::Picking_OnTerrain()
{
...
CToolBossTerrain* CToolBossTerrain::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CToolBossTerrain* pInstance = new CToolBossTerrain(pGraphicDev);
